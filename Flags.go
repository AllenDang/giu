...
const (
	PlotAxisFlagsNone          = PlotAxisFlags(imgui.ImPlotAxisFlags_None)
	PlotAxisFlagsNoLabel       = PlotAxisFlags(imgui.ImPlotAxisFlags_NoLabel)
	PlotAxisFlagsNoGridLines   = PlotAxisFlags(imgui.ImPlotAxisFlags_NoGridLines)
	PlotAxisFlagsNoTickMarks   = PlotAxisFlags(imgui.ImPlotAxisFlags_NoTickMarks)
	PlotAxisFlagsNoTickLabels  = PlotAxisFlags(imgui.ImPlotAxisFlags_NoTickLabels)
	PlotAxisFlagsLogScale      = PlotAxisFlags(imgui.ImPlotAxisFlags_LogScale)
	PlotAxisFlagsTime          = PlotAxisFlags(imgui.ImPlotAxisFlags_Time)
	PlotAxisFlagsInvert        = PlotAxisFlags(imgui.ImPlotAxisFlags_Invert)
	PlotAxisFlagsLockMin       = PlotAxisFlags(imgui.ImPlotAxisFlags_LockMin)
	PlotAxisFlagsLockMax       = PlotAxisFlags(imgui.ImPlotAxisFlags_LockMax)
	PlotAxisFlagsLock          = PlotAxisFlags(imgui.ImPlotAxisFlags_Lock)
	PlotAxisFlagsNoDecorations = PlotAxisFlags(imgui.ImPlotAxisFlags_NoDecorations)
)
