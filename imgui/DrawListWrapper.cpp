...
void iggDrawListAddRect(IggDrawList handle, IggVec2 *p_min, IggVec2 *p_max, unsigned int col, float rounding, int rounding_corners, float thickness)
{
  ImDrawList *list = reinterpret_cast<ImDrawList*>(handle);
...
void iggDrawListAddRectFilled(IggDrawList handle, IggVec2 *p_min, IggVec2 *p_max, unsigned int col, float rounding, int rounding_corners)
{
  ImDrawList *list = reinterpret_cast<ImDrawList*>(handle);
  Vec2Wrapper p1Arg(p_min);
  Vec2Wrapper p2Arg(p_max);
...
void iggDrawListAddText(IggDrawList handle, IggVec2 *pos, unsigned int col, const char *text)
{
  ImDrawList *list = reinterpret_cast<ImDrawList*>(handle);
...
void iggDrawListAddBezierCurve(IggDrawList handle, IggVec2 *pos0, IggVec2 *cp0, IggVec2 *cp1, IggVec2 *pos1, unsigned int col, float thickness, int num_segments)
{
  ImDrawList *list = reinterpret_cast<ImDrawList*>(handle);
  ...
  list->AddBezierCurve(*pos0Arg, *cp0Arg, *cp1Arg, *pos1Arg, col, thickness, num_segments);
}

void iggDrawListAddTriangle(IggDrawList handle, IggVec2 *p1, IggVec2 *p2, IggVec2 *p3, unsigned int col, float thickness)
{
  ImDrawList *list = reinterpret_cast<ImDrawList*>(handle);
  Vec2Wrapper p1Arg(p1);
  Vec2Wrapper p2Arg(p2);
...
void iggDrawListAddTriangleFilled(IggDrawList handle, IggVec2 *p1, IggVec2 *p2, IggVec2 *p3, unsigned int col)
{
  ImDrawList *list = reinterpret_cast<ImDrawList*>(handle);
  Vec2Wrapper p1Arg(p1);
  Vec2Wrapper p2Arg(p2);
...
void iggDrawListAddCircle(IggDrawList handle, IggVec2 *center, float radius, unsigned int col, int num_segments, float thickness)
{
  ImDrawList *list = reinterpret_cast<ImDrawList*>(handle);
...
void iggDrawListAddCircleFilled(IggDrawList handle, IggVec2 *center, float radius, unsigned int col, int num_segments)
{
  ImDrawList *list = reinterpret_cast<ImDrawList*>(handle);
  Vec2Wrapper centerArg(center);
...
void iggDrawListAddQuad(IggDrawList handle, IggVec2 *p1, IggVec2 *p2, IggVec2 *p3, IggVec2 *p4, unsigned int col, float thickness)
{
  ImDrawList *list = reinterpret_cast<ImDrawList*>(handle);
  Vec2Wrapper p1Arg(p1);
  Vec2Wrapper p2Arg(p2);
...
void iggDrawListAddQuadFilled(IggDrawList handle, IggVec2 *p1, IggVec2 *p2, IggVec2 *p3, IggVec2 *p4, unsigned int col)
{
  ImDrawList *list = reinterpret_cast<ImDrawList*>(handle);
  Vec2Wrapper p1Arg(p1);
  Vec2Wrapper p2Arg(p2);
...
void iggDrawListPathStroke(IggDrawList handle, unsigned int col, IggBool closed, float thickness)
{
  ImDrawList *list = reinterpret_cast<ImDrawList*>(handle);
  list->PathStroke(col, closed != 0, thickness);
}

void iggDrawListPathArcTo(IggDrawList handle, IggVec2 *center, float radius, float a_min, float a_max, int num_segments)
{
  ImDrawList *list = reinterpret_cast<ImDrawList*>(handle);
  Vec2Wrapper centerArg(center);
...
void iggDrawListPathArcToFast(IggDrawList handle, IggVec2 *center, float radius, int a_min_of_12, int a_max_of_12)
{
  ImDrawList *list = reinterpret_cast<ImDrawList*>(handle);
  Vec2Wrapper centerArg(center);
...
void iggDrawListPathBezierCurveTo(IggDrawList handle, IggVec2 *p1, IggVec2 *p2, IggVec2 *p3, int num_segments)
{
  ImDrawList *list = reinterpret_cast<ImDrawList*>(handle);
  Vec2Wrapper p1Arg(p1);
  Vec2Wrapper p2Arg(p2);
