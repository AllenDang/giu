...
IMGUI_API bool OpenPopupContextItem(
...
enum ImGuiWindowFlags_ {
  ...
  // around items or windows. ImGuiWindowFlags_ResizeFromAnySide    = 1 << 17, //
  // --> Set io.ConfigWindowsResizeFromEdges=true and make sure mouse cursors are
...
enum ImGuiPopupFlags_ {
  ...
  ImGuiPopupFlags_MouseButtonRight =
      1, // For BeginPopupContext*(): open on Right Mouse release. Guaranted to
         // always be == 1 (same as ImGuiMouseButton_Right)
  ImGuiPopupFlags_MouseButtonMiddle =
      2, // For BeginPopupContext*(): open on Middle Mouse release. Guaranted to
...
struct ImGuiIO {
  ...
  bool ConfigWindowsMoveFromTitleBarOnly; // = false       // [BETA] Set to true
                                          // to only allow moving windows when
  ...
  float ConfigWindowsMemoryCompactTimer;  // = 60.0f          // [BETA] Compact
                                         // window memory usage when unused. Set
                                         // to -1.0f to disable.
...
static inline bool OpenPopupOnItemClick(const char *str_id = NULL,
...
struct ImDrawList {
  ...
  ImDrawCmd _CmdHeader; // [Internal] Template of active commands. Fields should
